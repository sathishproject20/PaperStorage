...
if __name__ == "__main__":
    file_path = "/PATH_TO_FOLDER/INPUTHEX.txt"  # Replace with your file path of 1MB Hex File
    img = generate_hex_image_from_file(file_path)

    # Save the image to a file
    img.save("hex_image_from_file.png")
    print("Image generated and saved as 'hex_image_from_file.png'")
