...
def convert_ascii_to_pattern(input_file, json_file, output_dir="output", delimiter="A"):
    ...
    # Convert every two ASCII decimals to the corresponding dictionary value and add the delimiter
    ...
    if result_string.endswith(delimiter):
