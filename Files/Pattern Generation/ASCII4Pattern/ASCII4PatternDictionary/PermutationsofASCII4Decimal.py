...
def generate_permutations_and_save(start_index, end_index, num_files_in_batch, lines_per_file, output_dir="ascii4"):
    ...
    def write_to_file(data_batch, file_index):
        file_path = os.path.join(output_dir, f"ASCII4Permutations_{file_index}.txt")
...
end_index = 131072     # End index of range (currently not used in this context)
num_files_in_batch = 2 # Number of files to create
